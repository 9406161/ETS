...
<div id="main">
	<div id="writewr">
		<form role="form" action="/ETS/board/update" method="post">
			<input type="hidden" name="bno" value="${update.bno}" id="bno"><br>
			...
			<div class="fileDrop">+ 파일</div>
			<button type="button" id="list" class="btn" onClick="ETS/board/list">목록</button>
